...
#fix variables and make them functional 
...
#subset data with specific price
minprice<-10000
...
#with dupadd here if it is not a duplicate, 
for(i in 1:2818) {
...
#need google API key for this to work now. geocode does not work without key anymore
library(ggmap)
...
# you can use this for modeling and predicting on test set
